...
am_rel_srcdir='.'
am_top_srcdir='/home/ssbai/mini2440_buildroot/output/build/host-automake-1.14.1'
am_top_builddir='/home/ssbai/mini2440_buildroot/output/build/host-automake-1.14.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/ssbai/mini2440_buildroot/output/host/usr/share/automake-1.14/am'
    am_automake_acdir='/home/ssbai/mini2440_buildroot/output/host/usr/share/aclocal-1.14'
    am_bindir='/home/ssbai/mini2440_buildroot/output/host/usr/bin'
    am_datadir='/home/ssbai/mini2440_buildroot/output/host/usr/share'
    am_docdir='/home/ssbai/mini2440_buildroot/output/host/usr/share/doc/automake'
    am_pkgvdatadir='/home/ssbai/mini2440_buildroot/output/host/usr/share/automake-1.14'
    am_scriptdir='/home/ssbai/mini2440_buildroot/output/host/usr/share/automake-1.14'
    am_system_acdir='/home/ssbai/mini2440_buildroot/output/host/usr/share/aclocal'
    ;;
  no)
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/ssbai/mini2440_buildroot/output/host/usr/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/ssbai/mini2440_buildroot/output/host/usr/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/ssbai/mini2440_buildroot/output/host/usr/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/ssbai/mini2440_buildroot/output/host/usr/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/ssbai/mini2440_buildroot/output/host/usr/include'}}
