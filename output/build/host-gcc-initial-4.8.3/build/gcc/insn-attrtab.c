...
insn_current_length (rtx insn ATTRIBUTE_UNUSED)
{
  switch (recog_memoized (insn))
    ...
    case 238:  /* *arm_jump */
      ...
      if ((
#line 117 "../../gcc/config/arm/arm.md"
...
#line 894 "../../gcc/config/arm/thumb2.md"
(which_alternative)))))
        {
	  return 2;
        }
...
(TARGET_THUMB2)) && ((((INSN_ADDRESSES_SET_P () ? INSN_ADDRESSES (INSN_UID (GET_CODE (operands[0]) == LABEL_REF ? XEXP (operands[0], 0) : operands[0])) : 0) - (insn_current_reference_address (insn))) >= (-250)) && (((INSN_ADDRESSES_SET_P () ? INSN_ADDRESSES (INSN_UID (GET_CODE (operands[0]) == LABEL_REF ? XEXP (operands[0], 0) : operands[0])) : 0) - (insn_current_reference_address (insn))) <= (256))))
    ...
    case 215:  /* *addsi3_cbranch */
      extract_constrain_insn_cached (insn);
      if ((
#line 7464 "../../gcc/config/arm/arm.md"
(which_alternative)) < (2))
        {
...
(IS_THUMB_NO))))
    ...
    case 649:  /* *movdf_vfp */
	  ...
	  return 8;
        ...
        {
	  if (
#line 465 "../../gcc/config/arm/vfp.md"
(TARGET_VFP_SINGLE))
	    {
	      return 8;
	    }
    ...
    case 644:  /* *movdi_vfp_cortexa8 */
	  ...
	  return 16 /* 0x10 */;
        ...
        {
	  return 
#line 225 "../../gcc/config/arm/vfp.md"
...
(IS_THUMB_YES))))
    ...
    case 794:  /* *neon_movei */
      extract_constrain_insn_cached (insn);
      return 
#line 156 "../../gcc/config/arm/neon.md"
...
(TARGET_VFP_SINGLE))
    ...
    case 425:  /* *iwmmxt_arm_movdi */
	  ...
	  return 16 /* 0x10 */;
        ...
        {
	  if ((
#line 154 "../../gcc/config/arm/iwmmxt.md"
(TARGET_VFP_SINGLE)) == (1))
	    {
	      return 8;
	    }
    ...
    case 325:  /* *push_multi */
      extract_constrain_insn_cached (insn);
      return 
#line 10937 "../../gcc/config/arm/arm.md"
...
bypass_p (rtx insn ATTRIBUTE_UNUSED)
{
  ...
  switch (recog_memoized (insn))
    ...
    case 704:  /* *cmpsf_vfp */
      if (((((((
#line 5 "../../gcc/config/arm/arm-tune.md"
(((enum attr_tune) arm_tune))) == (
(TUNE_ARM1020E)))) || (((
#line 5 "../../gcc/config/arm/arm-tune.md"
(((enum attr_tune) arm_tune))) == (
(TUNE_ARM1022E))))) && (((
#line 85 "../../gcc/config/arm/arm.md"
(arm_fpu_attr)) == (
(FPU_VFP)))))) || (((((
#line 5 "../../gcc/config/arm/arm-tune.md"
(((enum attr_tune) arm_tune))) == (
...
#line 105 "../../gcc/config/arm/arm.md"
...
(TARGET_THUMB2)))))
    ...
    case 527:  /* rorv4hi3 */
      extract_constrain_insn_cached (insn);
      if ((which_alternative != 1) || (
#line 151 "../../gcc/config/arm/arm.md"
...
(((enum attr_tune) arm_tune))) == (
(TUNE_CORTEXA8)))) && (
#line 138 "../../gcc/config/arm/arm.md"
...
#line 109 "../../gcc/config/arm/arm.md"
(TARGET_THUMB)))
        {
	  return ARCH_ENABLED_YES;
        }
...
#line 125 "../../gcc/config/arm/arm.md"
(TARGET_32BIT && arm_arch6)))
        {
	  return ARCH_ENABLED_YES;
        }
      else if ((cached_arch == ARCH_NOV6) && (
#line 129 "../../gcc/config/arm/arm.md"
(TARGET_32BIT && !arm_arch6)))
        {
	  return ARCH_ENABLED_YES;
        }
...
get_attr_ce_count (rtx insn ATTRIBUTE_UNUSED)
{
  switch (recog_memoized (insn))
    ...
    case 3514:  /* *p *movdi_vfp_cortexa8 */
      extract_constrain_insn_cached (insn);
      return 
#line 233 "../../gcc/config/arm/vfp.md"
...
#line 164 "../../gcc/config/arm/arm.md"
...
get_attr_far_jump (rtx insn ATTRIBUTE_UNUSED)
{
  ...
  switch (recog_memoized (insn))
    ...
    case 214:  /* *cbranchne_decr1 */
      extract_constrain_insn_cached (insn);
      if ((((
#line 7355 "../../gcc/config/arm/arm.md"
(which_alternative)) == (0)) && ((cached_length = get_attr_length (insn)) == 8)) || ((cached_length = get_attr_length (insn)) == 10 /* 0xa */))
    ...
    case 215:  /* *addsi3_cbranch */
      extract_constrain_insn_cached (insn);
      if ((((
#line 7456 "../../gcc/config/arm/arm.md"
...
get_attr_neon_type (rtx insn ATTRIBUTE_UNUSED)
{
  switch (recog_memoized (insn))
    ...
    case 889:  /* fmsubv2sf4_intrinsic */
      extract_constrain_insn_cached (insn);
      if (
#line 4487 "../../gcc/config/arm/neon.md"
(true))
        {
...
(false))
    ...
    case 1863:  /* neon_vabdv8qi_2 */
      extract_constrain_insn_cached (insn);
      if ((
#line 6001 "../../gcc/config/arm/neon.md"
(false)) != (0))
        {
	  if ((
#line 6002 "../../gcc/config/arm/neon.md"
(true)) != (0))
	    {
	      return NEON_TYPE_NEON_FP_VADD_DDD_VABS_DD;
	    }
...
(false)) != (0))
    ...
    case 1872:  /* neon_vabdv8qi_3 */
      extract_constrain_insn_cached (insn);
      if ((
#line 6016 "../../gcc/config/arm/neon.md"
(false)) != (0))
        {
	  if ((
#line 6017 "../../gcc/config/arm/neon.md"
(true)) != (0))
	    {
	      return NEON_TYPE_NEON_FP_VADD_DDD_VABS_DD;
	    }
...
#line 168 "../../gcc/config/arm/arm.md"
