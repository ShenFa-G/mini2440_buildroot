...
#line 65 "../../gcc/config/arm/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 96 "../../gcc/config/arm/predicates.md"
(subreg_lowpart_p (op)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 115 "../../gcc/config/arm/predicates.md"
(const_ok_for_arm (-INTVAL (op))));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 119 "../../gcc/config/arm/predicates.md"
(const_ok_for_arm (~INTVAL (op))));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 123 "../../gcc/config/arm/predicates.md"
(INTVAL (op) == 0));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 143 "../../gcc/config/arm/predicates.md"
...
#line 148 "../../gcc/config/arm/predicates.md"
...
#line 157 "../../gcc/config/arm/predicates.md"
...
#line 176 "../../gcc/config/arm/predicates.md"
...
arm_reload_memory_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 189 "../../gcc/config/arm/predicates.md"
((!CONSTANT_P (op)
		     && (true_regnum(op) == -1
			 || (REG_P (op)
			     && REGNO (op) >= FIRST_PSEUDO_REGISTER))))) && (
...
#line 197 "../../gcc/config/arm/predicates.md"
...
{
  return (
#line 200 "../../gcc/config/arm/predicates.md"
...
#line 208 "../../gcc/config/arm/predicates.md"
((!CONST_INT_P (op)
...
shiftable_operator (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 214 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
#line 234 "../../gcc/config/arm/predicates.md"
...
#line 239 "../../gcc/config/arm/predicates.md"
(!CONST_INT_P (XEXP (op, 1))
			      || ((unsigned HOST_WIDE_INT) INTVAL (XEXP (op, 1))) < 32)))) && (
#line 241 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op)));
}
...
minmax_operator (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 284 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
{
  return (GET_CODE (op) == REG) && ((
#line 288 "../../gcc/config/arm/predicates.md"
(REGNO (op) == CC_REGNUM)) && ((
#line 289 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op))) || (
...
#line 318 "../../gcc/config/arm/predicates.md"
...
#line 330 "../../gcc/config/arm/predicates.md"
{
...
#line 338 "../../gcc/config/arm/predicates.md"
{
...
#line 355 "../../gcc/config/arm/predicates.md"
{
  if (s_register_operand (op, mode))
    return true;
...
#line 372 "../../gcc/config/arm/predicates.md"
{
...
#line 380 "../../gcc/config/arm/predicates.md"
{
...
#line 388 "../../gcc/config/arm/predicates.md"
{
 return ldm_stm_operation_p (op, /*load=*/true, SImode,
                                 /*consecutive=*/false,
                                 /*return_pc=*/true);
...
#line 404 "../../gcc/config/arm/predicates.md"
{
...
#line 450 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 454 "../../gcc/config/arm/predicates.md"
...
#line 468 "../../gcc/config/arm/predicates.md"
...
#line 484 "../../gcc/config/arm/predicates.md"
{
...
#line 491 "../../gcc/config/arm/predicates.md"
{
...
#line 497 "../../gcc/config/arm/predicates.md"
{
...
#line 524 "../../gcc/config/arm/predicates.md"
{
  return (TARGET_NEON
...
{
  return (
#line 540 "../../gcc/config/arm/predicates.md"
...
#line 551 "../../gcc/config/arm/predicates.md"
{
...
#line 609 "../../gcc/config/arm/predicates.md"
...
((ival & 0xfffff000) == 0));
    ...
    case CONSTRAINT_PJ:
      return (
#line 83 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2)) && (
...
(((-ival) & 0xfffff000) == 0));
    ...
    case CONSTRAINT_I:
      return 
#line 101 "../../gcc/config/arm/constraints.md"
...
(TARGET_32BIT ? (ival >= -4095 && ival <= 4095)
    ...
    case CONSTRAINT_K:
      return 
#line 116 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT ? const_ok_for_arm (~ival)
...
(!TARGET_32BIT && (ival >= 0 && ival <= 31));
    ...
    case CONSTRAINT_O:
      return 
#line 145 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1 && ival >= -508 && ival <= 508
		   && ((ival & 3) == 0));

    case CONSTRAINT_Pa:
      return 
#line 151 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1 && ival >= -510 && ival <= 510
		    && (ival > 255 || ival < -255));

    case CONSTRAINT_Pb:
      return 
#line 157 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1 && ival >= -262 && ival <= 262
		    && (ival > 255 || ival < -255));

    case CONSTRAINT_Pc:
      return 
#line 163 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1
  		    && ival > 1020 && ival <= 1275);

    case CONSTRAINT_Pd:
      return 
#line 169 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1 && ival >= 0 && ival <= 7);

    case CONSTRAINT_Pe:
      return 
#line 174 "../../gcc/config/arm/constraints.md"
...
(TARGET_THUMB2 && ival >= 1 && ival <= 8);
    ...
    case CONSTRAINT_Pv:
      return 
#line 194 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= -255 && ival <= 0);

    case CONSTRAINT_Pw:
      return 
#line 199 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= -255 && ival <= -1);

    case CONSTRAINT_Px:
      return 
#line 204 "../../gcc/config/arm/constraints.md"
